...
public class MainContainer extends Component {
    ...
    private void addTabObjects() {
        ...
        for (int i = 0; i < groundSprites.sprites.size(); i++) {
            ...
            // Add first tab container objects
            GameObject obj = new GameObject("Generated", new TransForm(new Vector2(x, y)), 10);
            obj.setUI(true);
            ...
            // make a function takes in a sprite as a parameter and returns the obj
            if (i == 0) {
                obj = new GameObject("Gen", new TransForm(new Vector2(x, y)), 10);
                obj.setUI(true);
                obj.setNonserializable();
